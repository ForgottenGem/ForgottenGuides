...
<nav class="breadcrumbs" aria-label="Breadcrumb">
  <span class="current">PlayStation 3</span>
</nav>
...
<div class="box-art-carousel">
  ...
  <figure class="image-block">
    <img id="box-art-image"
         src="{{ '/assets/images/misc/PS3FAT.png' | relative_url }}"
         alt="The PlayStation 3 Standard Edition"
         class="box-art">
    <figcaption id="box-art-caption">The PlayStation 3 Standard Edition</figcaption>
  </figure>
  <button class="carousel-btn" onclick="changeBoxArt(1)">›</button>
</div>
<script>
  const boxArts = [
    {
      src: "{{ '/assets/images/misc/PS3FAT.png' | relative_url }}",
      caption: "The PlayStation 3 Standard Edition",
      alt: "The PlayStation 3 Standard Edition"
    },
    {
      src: "{{ '/assets/images/misc/PS3.png' | relative_url }}",
      caption: "The PlayStation 3 Slim Edition",
      alt: "The PlayStation 3 Slim Edition"
    },
    {
      src: "{{ '/assets/images/misc/PS3Slim.png' | relative_url }}",
      caption: "The PlayStation 3 Super Slim Edition",
      alt: "The PlayStation 3 Super Slim Edition"
    }
  ];
  let currentBoxArt = 0;
